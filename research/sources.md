...
> **Selection bar:** Every person here actively runs or has run outbound (as a rep, leader, or agency operator) and publishes tactical, first-hand material — not aggregated listicle content. Roles/links were checked in June 2026 but titles change fast in this space; re-verify before citing in the final playbook.

## How the 10 were chosen

A cold outreach *pipeline* has four layers. The list deliberately covers all of them instead of stacking 10 "cold email tips" voices:

1. **Messaging & copy** — what makes a cold email/call actually get a reply
2. **Cold calling & live conversations** — openers, objections, booking the meeting
3. **Systems & infrastructure** — list building, deliverability, Clay/automation, sequencing
4. **Multichannel & social** — LinkedIn touches, video prospecting, allbound

---

## The 10 experts

### 1. Jason Bay — Outbound Squad
- **Layer:** Messaging + full outbound system (training side)
- **LinkedIn:** https://www.linkedin.com/in/jasondbay
- **YouTube/Podcast:** Outbound Squad podcast — https://outboundsquad.com/podcast/ (also on YouTube)
- **Why he's on the list:** Trained 20,000+ reps at companies like Gong, Zoom, and Rippling; ran a study of 85M+ cold emails with Gong. His content is framework-heavy (REPLY method, "martini glass" pipeline) and he interviews working reps, not just authors. The podcast back-catalogue is the single richest transcript source on this list.
- **Collect:** 10–15 recent podcast/YouTube transcripts + latest LinkedIn posts.

### 2. Josh Braun — Braun Training
- **Layer:** Messaging & psychology
- **LinkedIn:** https://www.linkedin.com/in/josh-braun
- **Site/YouTube:** https://joshbraun.com (active YouTube channel with short tactical videos)
- **Why:** Former VP Sales (Basecamp/Highrise side of the ecosystem); built his entire brand on "detaching from the outcome" — poke-the-bear questions, illuminating the problem instead of pitching. Highest signal-per-post ratio on LinkedIn in this niche.
- **Collect:** LinkedIn posts (he posts near-daily) + YouTube shorts transcripts.

### 3. Armand Farrokh & Nick Cegelski — 30 Minutes to President's Club (counted as one source)
- **Layer:** Cold calling + full top-of-funnel
- **YouTube:** https://www.youtube.com/@30MPC | **Site:** https://www.30mpc.com
- **Why:** The most-cited tactical sales podcast in B2B SaaS; both hosts were top-performing AEs/leaders (Armand was VP Sales at Pave). Every episode is timestamped tactics — cold call openers, objection handling, sequence structure. They also published the book *Cold Calling Sucks (And That's Why It Works)*, built on a dataset of ~300M cold calls (verify exact figure before quoting).
- **Collect:** Transcripts of their prospecting-tagged episodes (they tag episodes by topic).

### 4. Will Allred — Co-founder, Lavender
- **Layer:** Cold email, data-backed
...
- **YouTube:** Flip the Script channel
...
- **YouTube:** posts full Clay build walkthroughs
- **Why:** Runs an outbound agency sending at serious volume; publishes his actual Clay tables, inbox setups, and campaign math in public. The strongest "pipeline as engineering" source — exactly the layer most expert lists miss.
- **Collect:** YouTube walkthrough transcripts (long, dense, highly practical).
...
## Bench (swap-ins if a primary source proves thin)

- **Charlotte Johnson** (AE, Salesloft) — rep-level cold outreach posts with real examples
- **Kellen Casebeer** (The Deal Lab) — cold email systems/segmentation deep dives
- **Anthony Iannarino** — veteran voice, broader sales effectiveness
- **Mark Colgan** — trigger-based outbound campaigns for B2B SaaS

## Verification notes (honesty log)
